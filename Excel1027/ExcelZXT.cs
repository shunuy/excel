...
namespace Excel1027
{
    class ExcelZXT
    {
        ...
        private void LoadData()
        {
            ...
            xlSheet.Cells[1, 2] = "开放式基金";
            xlSheet.Cells[1, 3] = "偏股型基金";
            for (int i = 1; i <= 12; i++)
            {
                xlSheet.Cells[i+1, 1] = i.ToString() + "月";
                xlSheet.Cells[i+1, 2] = ran.Next(20000).ToString();
                xlSheet.Cells[i+1, 3] = ran.Next(15000).ToString();
            }
        ...
        private void CreateChart()
        {
            ...
            s1.BarShape = XlBarShape.xlConeToMax;
